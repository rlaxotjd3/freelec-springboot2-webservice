...
public class PostsApiControllerTest {
    ...
    public void Posts_등록된다() throws Exception {
        ...
        * @WebMvcTest의 경우 JPA 기능이 작동하지 않기 때문인데, Controller와 ControllerAdvice 등 외부 연동과 관련된 부분만
        * 활성화 되니, 지금같이 JPA 기능 까지 한번에 테스트할 때는 @SpringBootTest와 TestRestTemplate를 사용하면 됩니다.*/
        //given
        String title = "title";
    ...
    /*
    예전 myBatis를 쓰던 것과 달리 JPA를 씀으로 좀더 객체지향적으로 코딩이 가능.
